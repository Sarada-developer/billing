...
class Companies_model extends CI_Model
{
    ...
    {
        $this->db->select("id, (CASE WHEN company = '-' THEN name ELSE CONCAT(name, ' (', phone, ')') END) as text, (CASE WHEN company = '-' THEN name ELSE CONCAT(company, ' (', name, ')') END) as value, phone", false);
    ...
    public function getCustomerPointsByCustomer($id){
        $this->db->where("id",$id);
