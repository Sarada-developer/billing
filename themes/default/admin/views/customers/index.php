...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            {column_number: 4, filter_default_label: "[<?=lang('price_group');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('customer_group');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('vat_no');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('gst_no');?>]", filter_type: "text", data: []},
