    ...
    $(document).ready(function () {
        ...
        oTable = $('#POSData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": balance}, {"mRender": row_status}, {"mRender": pay_status}, {"mRender": currencyFormat} ,{"bSortable": false}],
            ...
            {column_number: 9, filter_default_label: "[<?=lang('earned_point');?>]", filter_type: "text", data: []},
