...
<ul id="myTab" class="nav nav-tabs no-print">
    ...
    <li class=""><a href="#point_history" class="tab-grey"><?= lang('point_history') ?></a></li>
</ul>
...
<div id="point_history" class="tab-pane fade in">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#PointRData').dataTable({
                'sAjaxSource': '<?= admin_url('reports/getPointReport/?v=1' . $p) ?>'
            });
        ...
        <div class="box payments-table">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-money nb"></i><?= lang('customer_point_history'); ?> <?php
                if ($this->input->post('start_date')) {
                    echo 'From ' . $this->input->post('start_date') . ' to ' . $this->input->post('end_date');
                }
                ?></h2>
