...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"mRender": currencyFormat}, {"bSortable": false,"mRender": attachment}, {"bVisible": false}, {"bSortable": false}],
            ...
            {column_number: 10, filter_default_label: "[<?=lang('earned_point');?>]", filter_type: "text", data: []},
