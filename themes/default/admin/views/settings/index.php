    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Ratio</legend>
                        <div class="col-md-4">
                            <div class="form-group">
                                 <label class="control-label" for="ratio"><?= lang('ratio'); ?></label>
                                <?= form_input('ratio', $Settings->ratio, 'class="form-control tip" id="ratio"'); ?> 
                            </div>
                        </div>
                </fieldset>
